        ...
        <div className={styles.FAQSBox}>
          ...
          <div className={styles.FAQSBox1}>
            <div className={styles.FAQdiv} onClick={() => handleArrow('section1')}>
              <h4>Why should I chooseRSMINE for myRSMINEneeds?</h4>
              <IoIosArrowForward 
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section1' ? styles.show : styles.hide}`}>
              <p>We could begin by telling you how we sell tens of billions daily, we offer 24/7 English live chat, and for nearly a decade we’ve maintained our position as the #1RSMINEGold seller in the market, but who wants to hear about all of that stuff? Instead, we’d rather tell you about what benefits you.</p>
              <br />
              <p>RSMINEGP offers a variety of payment methods, providing our customers with the option that works best for them.RSMINE doesn’t require ID verification, plain and simple. We value your privacy and security, and our team doesn’t request you to prove who you are to complete a transaction. Speaking of our team, if you need any assistance with the purchase, everyRSMINE agent has been trained from years of experience to provide the best possible experience. We aim to deliver all orders within minutes and are readily available to answer questions or help at any time via our live chat.</p>
            </div>
          </div>
          ...
          <div className={styles.FAQSBox2}>
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section2' ? styles.show : styles.hide}`}>
              ...
              <br />
              <p>We take every precaution during the delivery process to ensure a secure trading experience to protect yourRSMINEaccount.</p>
            </div>
          </div>
          ...
          <div className={styles.FAQSBox4}>
            <div className={styles.FAQdiv} onClick={() => handleArrow('section4')}>
              <h4>Is buying fromRSMINE safe?</h4>
              <IoIosArrowForward 
          ...
          <div className={styles.FAQSBox5}>
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section5' ? styles.show : styles.hide}`}>
              <p>Absolutely!RSMINE prides itself on being able to provide a variety of payment methods and the best prices in the market. Whether you’re selling gold from a big item drop, or taking a break fromRunescapeGP, we are always purchasing gold, and you can feel safe in knowing you’re picking a trustworthy site to sell to. 
          ...
          <div className={styles.FAQSBox6}>
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section6' ? styles.show : styles.hide}`}>
              <p>No, a registered account isn’t required to useRSMINE. Whether you’re selling, swapping, or buying gold, you can do so freely without an account.RSMINE believes in privacy. and we understand that not everybody wants to use an account. 
				
              </p>
              <br />
              <br />
              <p>With that being said, though, by registering, you gain access to unique features such as easy access to your order history, exclusive discounts, and updated notices on what’s new atRSMINE. Registration will always be free, so you’re welcome to at any point.</p>
            </div>
          </div>
          <div className={styles.FAQSBox7}>
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section7' ? styles.show : styles.hide}`}>
              <p>RSMINEGP believes in being an accessible platform for all customers. The only requirement when purchasing from us is to use a valid email to receive your order information and yourRSMINEusername. Unlike many other sites, we do not require you to divulge personal information such as a picture of your ID or Passport. 
